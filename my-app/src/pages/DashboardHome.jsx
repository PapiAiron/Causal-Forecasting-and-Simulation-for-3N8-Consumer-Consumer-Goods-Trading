...
const Sidebar = ({ isOpen, onToggle, activeTab, onTabChange }) => {
  ...
  return (
    <>
      ...
      <div
        className={`fixed left-0 top-0 h-full bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl border-r border-gray-200/50 dark:border-gray-700/50 z-50 transition-all duration-300 ease-out shadow-2xl ${
                    ...
                    <div className="absolute right-0 top-full mt-3 w-80 bg-white/95 dark:bg-gray-800/95 backdrop-blur-xl rounded-3xl shadow-2xl border border-gray-200/50 dark:border-gray-700/50 z-50 overflow-hidden">
                      <div className="px-6 py-4 border-b border-gray-200/30 dark:border-gray-700/30">
                        ...
                        <p className="text-xs text-gray-500 dark:text-gray-400">
                          {notifications} user{notifications !== 1 ? "s" : ""}{" "}
                          awaiting approval
                        </p>
                      </div>
                      <div className="max-h-96 overflow-y-auto">
                        {pendingUsers.length === 0 ? (
                          ...
                          pendingUsers.map((user) => (
                            <div
                              key={user.id}
                              className="p-4 border-b border-gray-200/30 dark:border-gray-700/30 hover:bg-gray-50 dark:hover:bg-gray-700/50"
                            >
...
const DashboardContent = ({ onNavigate }) => {
  ...
  const dashboardCards = [
    ...
    },
    {
      ...
      description:
        "Monthly, weekly, and yearly sales + bottle category reports.",
      icon: Calendar,
...
const LayoutWrapper = ({ children, currentPage, onNavigate }) => {
  ...
  return (
    <div className="bg-gradient-to-br from-gray-50 via-gray-100 to-gray-50 dark:from-gray-900 dark:via-gray-850 dark:to-gray-900 transition-all duration-500">
      <Sidebar
        isOpen={sidebarOpen}
